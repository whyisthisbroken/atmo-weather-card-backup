...
function _migrateConfig(raw) {
    ...
    const hasLegacyChipAreaKeys = c.chips_position !== undefined || c.chips_layout !== undefined ||
...
const LABELS = Object.freeze({
    ...
    perf_mode: "Performance Preset", perf_fps: "Frame Rate", perf_cloud_quality: "Cloud Detail", perf_effects: "Weather Effects", perf_fauna: "Birds & Planes", perf_dpr: "Sharpness"});
...
const KEY_ORDER = Object.freeze([
    ...
    "perf_mode", "perf_fps", "perf_cloud_quality", "perf_effects", "perf_fauna", "perf_dpr",
    "chips", "custom_cards"]);
...
const TOP_LEVEL_NUMBER_FIELDS = Object.freeze([
    "card_stack_order", "celestial_size", "celestial_x", "celestial_y", "image_scale",
    "chip_area_columns", "chip_area_scroll_count", "perf_fps", "perf_cloud_quality",
    "perf_effects", "perf_fauna", "perf_dpr"
]);
const TOP_LEVEL_BOOLEAN_FIELDS = Object.freeze([
    "card_square", "card_hide_text", "chip_area_hide", "chip_area_full_width", "chip_area_background",
    "chip_area_grouped", "chip_area_separator", "card_full_width", "card_mask_vertical",
    "card_mask_horizontal", "chip_icon_background"
]);
const CHIP_NUMBER_FIELDS = Object.freeze([
    "forecast_offset", "forecast_precision", "marquee_speed",
    "ring_min", "ring_max", "ring_width", "ring_gap",
    "bar_min", "bar_max", "bar_height", "bar_gap"
]);
const CHIP_BOOLEAN_FIELDS = Object.freeze([
    "hide_icon", "hide_label", "hide_value", "hide_sub_value", "marquee_rtl",
    "background", "icon_background", "fancy_unit", "chip_round", "behind_effects"
]);
...
class AtmosphericWeatherCardEditor extends LitElement {
    ...
    static get styles() {
        return css`
            ...
            .compact-field-hint {
                font-size: var(--awc-e-f-meta); color: var(--secondary-text-color); padding-left: 2px; line-height: 1.3;
            }
    ...
    _isValidCardHeight(value) {
        ...
        return /^-?\d+(?:\.\d+)?(px|em|rem|%|vh|vw|vmin|vmax|svh|lvh|dvh|ch|ex|cm|mm|in|pt|pc)$/i.test(raw);
    }
    _normalizeCardHeight(value) {
        ...
        if (/^-?\d+(?:\.\d+)?(px|em|rem|%|vh|vw|vmin|vmax|svh|lvh|dvh|ch|ex|cm|mm|in|pt|pc)$/i.test(raw)) return raw;
        return this._config && this._config.card_height ? this._config.card_height : "";
    }
    ...
    _normalizeConfigTypes(obj) {
        ...
        if (Array.isArray(obj.chips)) obj.chips = obj.chips.map((chip) => this._normalizeChipTypes(chip));
        return obj;
    }
    _valueChanged(ev) {
        ...
        const layoutSection = html`<div class="segmented" role="radiogroup" aria-label="Chip layout">
            ...
            <div class="settings-group">
                ...
                <div class="css-field-row cols-2">
                    ...
                    ${cssField("height", "Height", "e.g. 40px")}</div>
                <div class="css-field-row cols-2">
    ...
    _renderCompactField(field, placeholder) {
        ...
        return html`<div class="compact-field ${hasError ? "invalid" : ""}">
                ...
                >
                ${hasError ? html`<div class="compact-field-hint error">${this._cardHeightError}</div>` : ""}</div>`;}
    _renderChipsEditor() {
        ...
        const chipsContent = html`<div class="settings-group">
            ...
            <div class="fc-box" style="background:rgba(var(--rgb-primary-text-color,0,0,0),0.03)">
                <div style="display:flex;align-items:center;gap:var(--awc-e-s2);font-size:var(--awc-e-f-meta);color:var(--secondary-text-color)">
                    ...
                    <span>SVG icons: <a href="https://github.com/shpongledsummer/atmo-weather-card#weather-icons" target="_blank" rel="noopener" style="color:var(--primary-color)">How to add them</a></span>
                </div></div>`;}
    _renderPerformancePanel() {
        ...
        const onPreset = (name) => {
            ...
            this._patch(changes);};
        const DESCS = {
            perf_fps: { 24: "Battery saver", 30: "Balanced", 45: "Smoother", 60: "Maximum smoothness" },
        ...
        return html`<div class="grid-picker">
            ...
            ${this._renderDisclosure("Advanced Settings", html`
                ${perfButtons("perf_fps", LABELS.perf_fps, [
                    {value:24,label:"24"},{value:30,label:"30"},{value:45,label:"45"},{value:60,label:"60"}])}
...
if (!customElements.get("atmo-weather-card-editor")) {
    customElements.define("atmo-weather-card-editor", AtmosphericWeatherCardEditor);}
